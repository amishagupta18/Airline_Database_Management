...
try{
    $query="SELECT * FROM working_on ORDER BY employee_id";
...
<div id="navbar">
    ...
    <div class = "searchhead">Add An Employee & Flight Relationship</div>
    <form method="POST" action="">	
            ...
            <div class="fieldbox">
			<input id="tail" name="tail" type="text">
            <label>Tail #</label>
            <span></span>
            </div>
